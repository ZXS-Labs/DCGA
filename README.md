...
<p align="center">
  ...
  <h1 align="center">Depth Completion using Galerkin Attention</h1>

</p>
<p align="center">
  <a href="https://github.com/ZXS-abs/DCGA">
...
$ python main.py --dir_data PATH_TO_NYU --data_name NYU  --split_json ../data_json/nyu.json \
    --gpus 0 --max_depth 10.0 --num_sample 500 \
    --test_only --pretrain PATH_TO_WEIGHTS --save NYU_test
