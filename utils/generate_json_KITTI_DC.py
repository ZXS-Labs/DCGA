        ...
        for seq in list_seq:
            ...
            for cam in ['image_02', 'image_03']:
                ...
                for name in list_depth:
                    ...
                    path_rgb = 'rawdata/' +  seq_data + '/' + seq + '/' + seq_data + '/' + seq + '/' + cam + '/data/' + name
                    ...
                    path_gt ='data_depth_annotated/' +  split + '/' + seq + '/proj_depth/groundtruth/' \
                              + cam + '/' + name
                    path_calib = 'rawdata/' + seq_data + '/' + seq_data + '_calib/'  + seq_data + '/calib_cam_to_cam.txt'

                    dict_sample = {
                        'rgb': path_rgb,
                        'depth': path_depth,
                        'gt': path_gt,
                        'K': 'rawdata/' + seq_data + '/calib_cam_to_cam.txt'
                    }
